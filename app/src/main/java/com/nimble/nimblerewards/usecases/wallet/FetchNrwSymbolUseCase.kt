...
import com.nimble.nimblerewards.data.exceptions.NimbleRewardError.FetchNrwSymbolError
...
class FetchNrwSymbolUseCase @Inject constructor(
    ioThread: IoThread,
    ...
    override fun create(address: String): Single<String> {
        return blockChainRepository.fetchNrwSymbol(address)
    }

    override fun convertError(throwable: Throwable): (Throwable) -> AppError {
        return ::FetchNrwSymbolError
    }
}
